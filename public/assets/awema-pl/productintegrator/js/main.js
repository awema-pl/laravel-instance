(function () {
    ...
    var productintegratorMixin = {
        ...
        beforeCreate() {
            this._config = Object.assign( _config, AWEMA.utils.object.get(AWEMA_CONFIG, 'productintegrator', {}) );
        }
    };
    ...
    var script = {
        ...
        name: 'productintegrator',

        mixins: [ productintegratorMixin ],

        props: {
            name: {
                type: String,
                default() {
                    return `productintegrator-${ _uniqSectionId++ }`
                }
            },
        ...
        computed: {
            productintegrator() {
                return this.$store.state.productintegrator[this.name]
            },

            isLoading() {
                return this.productintegrator && this.productintegrator.isLoading
            },
        },
        ...
        created() {
            ...
            this.$store.commit('productintegrator/create', {
                name: this.name,
                data
            });
        },
        ...
        methods: {
            ...
            testLoading(){
                ...
                AWEMA.emit(`productintegrator::${this.name}:before-test-loading`);

                this.$store.dispatch('productintegrator/testLoading', {
                    name: this.name
                }).then( data => {
    ...
    var __vue_render__ = function() {
      ...
      return _c("div", [
        _c("p", [
          ...
          _c("code", [_vm._v("PRODUCTINTEGRATOR_EXAMPLE")]),
          _vm._v(" from "),
          _c("code", [_vm._v("productintegrator/resources/lang/**/js.php")]),
          _vm._v(": " + _vm._s(_vm.$lang.PRODUCTINTEGRATOR_EXAMPLE))
        ]),
        _vm._v(" "),
        _c(
          "button",
    ...
    __vue_render__._withStripped = true;
      ...
      var productintegrator = normalizeComponent_1(
    ...
    function install(Vue) {
        ...
        /Vue.component('productintegrator', productintegrator);
    ...
    var lang = {
        PRODUCTINTEGRATOR_EXAMPLE: 'productintegrator example',
    };
    ...
    const getters = {
        ...
        productintegrator: state => name => {
            return state[name]
        },

        isLoading: (state, getters) => name => {
            const productintegrator = getters.productintegrator(name);
            return productintegrator && productintegrator.isLoading
        },
    };
    ...
    const actions = {
        ...
        restoreData({ state }, { name }) {
            const productintegrator = state[name];
            return productintegrator.exampleData || 'example-data';
        },
    ...
    const awemaPlugin = {
        ...
        install(AWEMA) {
            ...
            AWEMA._store.registerModule('productintegrator', productintegratorModule);
            AWEMA.lang = lang;
        }
    };
