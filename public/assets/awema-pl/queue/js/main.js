(function () {
    ...
    var queueMixin = {
        ...
        beforeCreate() {
            this._config = Object.assign( _config, AWEMA.utils.object.get(AWEMA_CONFIG, 'queue', {}) );
        }
    };
    ...
    var script = {
        ...
        computed: {
            queue() {
                return this.$store.state.queue[this.name]
            },

            isLoading() {
                return this.queue && this.queue.isLoading
            },
        },
        ...
        created() {
            ...
            this.$store.commit('queue/create', {
                name: this.name,
                data
            });
        },
        ...
        methods: {
            ...
            testLoading(){
                ...
                AWEMA.emit(`queue::${this.name}:before-test-loading`);

                this.$store.dispatch('queue/testLoading', {
                    name: this.name
                }).then( data => {
      ...
      return _c("div", [
        _c("div", { staticClass: "grid" }, [
          _c("div", { staticClass: "cell-1-1 cell--dsm" }, [
            _c("h4", [_vm._v(_vm._s(_vm.$lang.JOBS))])
          ])
        ]),
        _vm._v(" "),
        _c(
    ...
    __vue_render__._withStripped = true;
      ...
      var queue = normalizeComponent_1(
    ...
    const getters = {
        ...
        isLoading: (state, getters) => name => {
            const queue = getters.queue(name);
            return queue && queue.isLoading
        },
    };
    ...
    const actions = {
        ...
        restoreData({ state }, { name }) {
            ...
            return queue.exampleData || 'example-data';
        },
    ...
    const awemaPlugin = {
        ...
        install(AWEMA) {
            ...
            AWEMA._store.registerModule('queue', queueModule);
            AWEMA.lang = lang;
        }
    };
