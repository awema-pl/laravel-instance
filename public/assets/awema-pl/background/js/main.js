(function () {
    ...
    var backgroundMixin = {
        ...
        beforeCreate() {
            this._config = Object.assign( _config, AWEMA.utils.object.get(AWEMA_CONFIG, 'background', {}) );
        }
    };
    ...
    var script = {
        ...
        props: {
            name: {
                type: String,
                default() {
                    return `background-${ _uniqSectionId++ }`
                }
            },
        ...
        computed: {
            background() {
                return this.$store.state.background[this.name]
            },

            isLoading() {
                return this.background && this.background.isLoading
            },
        },
        ...
        created() {
            ...
            this.$store.commit('background/create', {
                name: this.name,
                data
            });
        },
        ...
        methods: {
            ...
            testLoading(){
                ...
                AWEMA.emit(`background::${this.name}:before-test-loading`);

                this.$store.dispatch('background/testLoading', {
                    name: this.name
                }).then( data => {
    ...
    var __vue_render__ = function() {
      ...
      return _c("div", [
        _c("p", [
          ...
          _c("code", [_vm._v("BACKGROUND_EXAMPLE")]),
          _vm._v(" from "),
          _c("code", [_vm._v("background/resources/lang/**/js.php")]),
          _vm._v(": " + _vm._s(_vm.$lang.BACKGROUND_EXAMPLE))
        ]),
        _vm._v(" "),
        _c(
          "button",
    ...
    __vue_render__._withStripped = true;
      ...
      var background = normalizeComponent_1(
    ...
    var lang = {
        BACKGROUND_EXAMPLE: 'background example',
    };
    ...
    const getters = {
        ...
        isLoading: (state, getters) => name => {
            const background = getters.background(name);
            return background && background.isLoading
        },
    };
    ...
    const actions = {
        ...
        restoreData({ state }, { name }) {
            const background = state[name];
            return background.exampleData || 'example-data';
        },
    ...
    const awemaPlugin = {
        ...
        install(AWEMA) {
            ...
            AWEMA._store.registerModule('background', backgroundModule);
            AWEMA.lang = lang;
        }
    };
