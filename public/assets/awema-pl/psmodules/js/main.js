(function () {
    ...
    var psmodulesMixin = {
        ...
        beforeCreate() {
            this._config = Object.assign( _config, AWEMA.utils.object.get(AWEMA_CONFIG, 'psmodules', {}) );
        }
    };
    ...
    var script = {
        ...
        mixins: [ psmodulesMixin ],

        props: {
            name: {
                type: String,
                default() {
                    return `psmodules-${ _uniqSectionId++ }`
                }
            },
        ...
        computed: {
            psmodules() {
                return this.$store.state.psmodules[this.name]
            },

            isLoading() {
                return this.psmodules && this.psmodules.isLoading
            },
        },
        ...
        created() {
            ...
            this.$store.commit('psmodules/create', {
                name: this.name,
                data
            });
        },
        ...
        methods: {
            ...
            testLoading(){
                ...
                AWEMA.emit(`psmodules::${this.name}:before-test-loading`);

                this.$store.dispatch('psmodules/testLoading', {
                    name: this.name
                }).then( data => {
    ...
    var __vue_render__ = function() {
      ...
      return _c("div", [
        _c("p", [
          ...
          _c("code", [_vm._v("PSMODULES_EXAMPLE")]),
          _vm._v(" from "),
          _c("code", [_vm._v("psmodules/resources/lang/**/js.php")]),
          _vm._v(": " + _vm._s(_vm.$lang.PSMODULES_EXAMPLE))
        ]),
        _vm._v(" "),
        _c(
          "button",
    ...
    __vue_render__._withStripped = true;
      ...
      var psmodules = normalizeComponent_1(
    ...
    function install(Vue) {
        ...
        /Vue.component('psmodules', psmodules);
    ...
    var lang = {
        PSMODULES_EXAMPLE: 'psmodules example',
    };
    ...
    const getters = {
        ...
        psmodules: state => name => {
            return state[name]
        },

        isLoading: (state, getters) => name => {
            const psmodules = getters.psmodules(name);
            return psmodules && psmodules.isLoading
        },
    };
    ...
    const actions = {
        ...
        restoreData({ state }, { name }) {
            const psmodules = state[name];
            return psmodules.exampleData || 'example-data';
        },
    ...
    const awemaPlugin = {
        ...
        install(AWEMA) {
            ...
            AWEMA._store.registerModule('psmodules', psmodulesModule);
            AWEMA.lang = lang;
        }
    };
